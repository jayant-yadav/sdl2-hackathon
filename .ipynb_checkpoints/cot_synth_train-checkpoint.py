...
MODEL_LOAD_PATH = [ "../log_smhi/2023-09-28_11-04-23/model_it_2000000", "../log_smhi/2023-09-29_09-11-43/model_it_194042", '../log_smhi/2023-08-10_10-35-52/model_it_2000000', "../log_smhi/2023-09-29_09-02-45/model_it_191233"] #None  # None --> Model randomly initialized. Set to string pointing to model weights to init with those weights.
...
# NUM_TRAIN_ITER = 1_000_000  # For how many batches to train the model
NUM_TRAIN_ITER = 1_00_000  # For how many batches to train the model
...
#         },
#     'parameters': {
#         'batch size': {'values': [16, BATCH_SIZE, 64]},
#         'training itr': {'max': NUM_TRAIN_ITER, 'min': 50_000},
#         'learning_rate': {'max': 0.001, 'min': LR},
#         'weight decay': {'max': 0.01, 'min': WEIGHT_DECAY},
#         "beta 1": {'value': BETA1},
#      }
# }
...
if SAVE_MODEL_WEIGHTS:
	...
	wandb.run.summary["model path"] = os.path.join(log_dir, 'model_it_%d' % NUM_TRAIN_ITER)
